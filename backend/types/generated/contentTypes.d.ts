...
export interface ApiDomainDomain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    heads: Schema.Attribute.Relation<'manyToMany', 'api::member.member'>;
    icon: Schema.Attribute.Media<'images'>;
    leads: Schema.Attribute.Relation<'manyToMany', 'api::member.member'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::domain.domain'
...
export interface ApiFooterLinkFooterLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['social', 'quick_links']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    domainHeads: Schema.Attribute.Relation<'manyToMany', 'api::domain.domain'>;
    domainLeads: Schema.Attribute.Relation<'manyToMany', 'api::domain.domain'>;
    email: Schema.Attribute.Email;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    year: Schema.Attribute.Enumeration<['first', 'second', 'third', 'fourth']> &
      Schema.Attribute.Required;
    yearOfJoining: Schema.Attribute.Integer;
    yearOfLeaving: Schema.Attribute.Integer;
  };
}
